...
NOM_patients$ED_status <- ifelse(
  NOM_patients$ed_reasonoutcomes == 3 | NOM_patients$ed_reasonoutcomes == 4, 
  0, 
  NOM_patients$ED_status
)
...
ggsurvplot(km_fit, data = NOM_patients, conf.int = T, ggtheme = theme_survminer(),
           title = "Kaplan-Meier Survival Curve", xlab = "Days since NOM", ylab = "ED Visit Probability", palette = "blue")

na_fit <- survfit(Surv(time_to_ED, ED_status) ~ 1, data = NOM_patients, conf.type = "log-log") 
ggsurvplot(na_fit, fun = "cumhaz",  title = "Cumulative Hazard", xlab = "Days since NOM", ylab = "Hazard Rate",)
