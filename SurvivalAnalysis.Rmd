...
## Aalen Johansen Estimator of competing risk of urgent vs elective appy
```{r}
...
ggsurvplot(km_fit, data = NOM_patients, conf.int = T, ggtheme = theme_survminer(),
           title = "Kaplan-Meier Survival Curve", xlab = "Time", ylab = "ED Visit Probability", palette = "blue")
